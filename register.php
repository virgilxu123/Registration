    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty(trim($_POST["username"]))){
            ...
            if($stmt = mysqli_prepare($mysqli, $sql)){
                // Bind variables mysqli_prepareto the prepared statement as parameters
...
<body class="bg-secondary">
    <div class="container-fluid ">
        <div class="row justify-content-center ">
            <div class="col-md-3 bg-dark rounded my-5 py-3 mx-3">
                <p class="h2 text-center text-light">Sign Up</p>
                <p class=" text-center text-light">Please fill this form to create an account.</p>
